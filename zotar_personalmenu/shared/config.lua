...
Config.YourServerName = "ZOTAR DEV" -- Title of the personal menu
...
Config.EnableLog = false -- for active discord log, if you put true, put your webhooks in "config_webhooks" file.
